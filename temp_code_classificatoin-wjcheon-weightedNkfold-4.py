...
for iter10 in range(0, 500):
    ...
    for iter1 in range(1, 6):
        ...
        for e in tqdm(range(1, EPOCHS + 1)):
            ...
            for X_train_batch, y_train_batch in train_loader:
                ...
                train_loss = criterion(y_train_pred.squeeze(1), y_train_batch.long())
        ...
        # VALIDATION
                with torch.no_grad():
                    ...
                    for X_val_batch, y_val_batch in val_loader:
                        ...
                        y_pred_softmax_np = y_pred_softmax.cpu().detach().numpy()
    ...
    saveFileName = os.path.join(r"D:\BladderToxicityResult_full", currentDT.strftime("%Y-%m-%d-%H-%M-%S-Results.xlsx"))
